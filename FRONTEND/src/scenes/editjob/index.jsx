...
const JobsPosted = () => {
  ...
  const handleDialogSubmit = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        "http://localhost:5001/api/get_jobs"
      );
      setJobs(response.data);
      setEditDialogOpen(false);
      setEditedJob({});
  ...
  const handleConfirmDelete = () => {
    ...
    axiosInstance
      .delete(`http://localhost:5001/api/delete_job/${id}`)
      .then((response) => {
      ...
      <Dialog open={editDialogOpen} onClose={handleDialogClose}>
        ...
        <DialogContent sx={{ padding: "20px" }}>
          ...
          <TextField
            ...
            onChange={(e) =>
              setEditedJob({ ...editedJob, minPrice: e.target.value })
            }
            sx={{ marginBottom: "16px" }}
          />
          <TextField
            ...
            onChange={(e) =>
              setEditedJob({ ...editedJob, maxPrice: e.target.value })
            }
            sx={{ marginBottom: "16px" }}
          />
          <TextField
            ...
            onChange={(e) =>
              setEditedJob({ ...editedJob, salaryType: e.target.value })
            }
            sx={{ marginBottom: "16px" }}
          />
          <TextField
          ...
          <TextField
            ...
            onChange={(e) =>
              setEditedJob({ ...editedJob, postingDate: e.target.value })
            }
            sx={{ marginBottom: "16px" }}
          />
          <TextField
            ...
            onChange={(e) =>
              setEditedJob({ ...editedJob, experienceLevel: e.target.value })
            }
            sx={{ marginBottom: "16px" }}
          />
          <TextField
