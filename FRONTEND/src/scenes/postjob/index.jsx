...
const CreateJob = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axiosInstance.post(
        "http://localhost:5001/api/add_job",
        data
      );
  ...
  const options = [
    { value: "JavaScipt", lable: "JavaScipt" },
    { value: "C++", label: "C++" },
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              style={{ width: "50%", marginRight: "2%", padding: "12px 12px" }}
            >
              <label
                style={{
                  marginBottom: "0.5rem",
          ...
          >
            <div
              style={{ width: "50%", marginRight: "2%", padding: "12px 12px" }}
            >
              <label style={{ fontSize: "1.2rem", color: "#535353" }}>
                Salary Type
              </label>
              <select
                {...register("salaryType")}
          ...
          <div style={{ width: "100%" }}>
            ...
            <textarea
              {...register("employmentFutureGrowth")}
              style={{
                width: " 100%",
                paddingTop: "0.375rem",
                paddingBottom: "0.375rem",
              ...
              row={8}
              defaultValue={
                "We put people first,drive innovation and do good in the community we live and work in."
              }
              placeholder="Job Benefits"
            />
          </div>
          ...
          <div style={{ width: "100%" }}>
            ...
            <textarea
              ...
              row={8}
              defaultValue={
                "Ex: This position entails joining a web design and development team....!"
              }
              placeholder="Job Benefits"
            />
          </div>
